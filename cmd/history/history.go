...
func AppendToHistory(text model.Text, player string, timeSpent time.Duration) {
	...
	var newHistory = model.PlayedEntry{Id: maxId + 1, Text: text, Player: player, TimePlayed: time.Now(), TimeSpent: timeSpent, Wpm: wpm}
